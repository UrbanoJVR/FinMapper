...
class TestLoadTransactionsFile:
    ...
    def _expected_transactions_data() -> list[list[str]]:
        t1 = ["25/04/2024", "Adeudo a su cargo pequeneces", "-395"]
        t2 = ["21/04/2024", "Www.dazn.com", "-12,99"]
        t3 = ["21/04/2024", "Coviran", "-8,38"]
        t4 = ["19/04/2024", "Dia", "-5,73"]
        t5 = ["19/04/2024", "Adeudo repsol, s.l.u.", "-55,01"]
